...
Carecom is a Simple web project that is made for e-channeling Using PHP,HTML & CSS.
...
5. Create a new database naming `carecom`.
6. Import the provided SQL file. The file is known as DATABASE carecom.sql located inside the source code root folder.
7. Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/carecom-echanneling-main/.
